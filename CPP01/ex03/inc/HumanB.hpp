...
/*   Updated: 2026/07/28 12:44:47 by mefische         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*	HumanB may not have a weapon right away, so it stores a pointer to Weapon.
	...
	So, HumanB can exist before receiving a weapon. It also lets HumanB use the 
	same weapon object without making a copy. */
class HumanB {
	private:
		std::string	name;
		Weapon*		type;
